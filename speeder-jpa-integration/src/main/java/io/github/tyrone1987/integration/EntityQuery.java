 ...
 *
 * @author gilberto
 * @param <T> clas de la q depende esta interfaz
 */
public interface EntityQuery<T extends IEntity>
{
    ...
    /**
     * 
     * @param field nombre del campo por qel que se quiere ordenar de forma ascendente
     * @return un Query de la clase extendida
     */
    ...
    /**
     * 
     * @param field nombre del campo por qel que se quiere ordenar de forma descendiente
     * @return un Query de la clase extendida
     */
    ...
    /**
     * 
     * @param field nombre del campo por qel que se quiere ordenar
     * @param orderType tipo de orden para aplicar
     * @return un Query de la clase extendida
     */
