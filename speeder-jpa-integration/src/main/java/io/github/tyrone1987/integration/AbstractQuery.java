...
public abstract class AbstractQuery<T extends IEntity> implements EntityQuery<T>
{
    ...
    /**
     * Constructor que crea una nueva instancia a partir de una consulta ya inicializada.Este constructor no debe ser usado en cambio vease el metodo estatico find.
     * @param entityManager El contexto de persistencia a usar.
     * @param path El path a usar en la consulta.
     * @param query clase Criteria de JAP paa consultas
     * @param or indica si la consulta aplica AND u OR
     */
