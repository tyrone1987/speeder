...
public class QueryHelper
{
     ...
     * expression = value1 or expression = value2 .....y modifica el estado actual de las condiciones de un objeto QueryProvider
     * @param <T>
     ...
     */
    private static void addFilter(EntityManager em,QueryProvider provider, Predicate equalPredicate)
    {
