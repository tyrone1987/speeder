...
public class QueryProvider 
{
     ...
     * @param query Criteria para realizar la consulta
     * @param or indica si los filtros se aplican por or o and
     * @param em conexion sobre la q se realiza la consulta
     */
    ...
    /**
     * @param p parametro nuevo para la consulta
     */
